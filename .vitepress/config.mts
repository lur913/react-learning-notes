    ...
    nav: [
      {
        ...
        activeMatch: "/ui|interaction|state|escape/",
      },
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          {
            text: "使用JSX书写标签语言",
            link: "/ui/3-React-使用JSX书写标签语言",
          },
          {
            text: "JSX中使用JavaScript",
            link: "/ui/4-React-JSX中使用JavaScript",
          },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "State组件的记忆",
            link: "/interaction/2-React-State组件的记忆",
          },
          ...
          {
            text: "更新State中的对象",
            link: "/interaction/6-React-更新State中的对象",
          },
          {
            text: "更新State中的数组",
            link: "/interaction/7-React-更新State中的数组",
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            text: "State的保留和重置",
            link: "/state/4-React-State的保留和重置",
          },
          {
            text: "迁移状态逻辑至Reducer",
            link: "/state/5-React-迁移状态逻辑至Reducer",
          },
          {
            text: "使用Context深层传递参数",
            link: "/state/6-React-使用Context深层传递参数",
          },
          {
            text: "使用Reducer和Context拓展应用",
            link: "/state/7-React-使用Reducer和Context拓展应用",
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            text: "Effect副作用同步",
            link: "/escape/3-React-Effect副作用同步",
          },
          {
            text: "你可能不需要Effect",
            link: "/escape/4-React-你可能不需要Effect",
          },
          {
            text: "响应式Effect的生命周期",
            link: "/escape/5-React-响应式Effect的生命周期",
          },
          {
            text: "将事件从Effect中分开",
            link: "/escape/6-React-将事件从Effect中分开",
          },
          { text: "移除Effect依赖", link: "/escape/7-React-移除Effect依赖" },
          {
            text: "使用自定义Hook复用逻辑",
            link: "/escape/8-React-使用自定义Hook复用逻辑",
          },
        ],
      },
    ],
